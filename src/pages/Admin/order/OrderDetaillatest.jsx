...
import { FiEdit2, FiSave, FiX, FiMapPin, FiPlus, FiMinus, FiTrash2, FiHome, FiNavigation, FiSearch } from 'react-icons/fi';
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-rose-50">
      ...
      {showAddressMap && (
        <MapLocationPicker
          ...
          existingAddress={order.restaurant?.address}
        />
      )}
    </div>
  );
...
const MapLocationPicker = ({ onSave, onClose, selectedCustomer, existingAddress = null }) => {
  ...
  const addMarker = (coordinates) => {
    ...
    mapRef.current.flyTo({ center: coordinates, zoom: 15, duration: 1000 });
  };
  ...
  const handleSave = () => {
    ...
    const apiData = {
      ...
      location: {
        type: "Point",
        coordinates: [parseFloat(selectedLocation[0]), parseFloat(selectedLocation[1])]
      }
    };
        ...
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-800">Update Store Address</h3>
                <p className="text-gray-600 text-sm">Click on the map to select new location</p>
              </div>
            </div>
          ...
          <div className="w-full lg:w-2/5 p-6 overflow-y-auto border-r border-gray-200">
            <div className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full border border-gray-300 rounded-lg p-3 text-sm focus:ring-2 focus:ring-pink-500 focus:border-pink-500"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-300 rounded-lg p-2 text-sm focus:ring-2 focus:ring-pink-500 focus:border-pink-500"
                    placeholder="Area"
                  />
                </div>
                <div>
            ...
            <div className="flex space-x-3 pt-6 mt-4 border-t border-gray-200">
              ...
              <button
                ...
                className="flex-1 px-6 py-3 bg-pink-500 text-white rounded-lg hover:bg-pink-600 transition-all font-medium disabled:bg-gray-400 disabled:cursor-not-allowed"
              >
                Save Address
              </button>
            </div>
          ...
          <div className="w-full lg:w-3/5 flex flex-col">
            <div className="p-4 border-b border-gray-200 bg-gray-50">
              <div className="flex items-center space-x-2 text-sm text-gray-600">
                <FiNavigation className="text-pink-500" />
                <span>Click anywhere on the map to select store location</span>
              </div>
            </div>
            <div className="flex-1 relative">
              <div ref={mapContainer} style={{ height: "100%", width: "100%" }} className="rounded-r-lg" />
            </div>
          </div>
        </div>
      </div>
