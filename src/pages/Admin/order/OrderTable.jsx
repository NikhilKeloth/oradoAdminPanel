                            ...
                            <>
                              <div className="flex space-x-0.5">
                                <button
                                  ...
                                  className="flex-1 bg-green-500 hover:bg-green-600 text-white text-xs py-0.5 px-1.5 rounded flex items-center justify-center transition-colors disabled:opacity-50"
                                  title="Accept Order"
                                >
                                  {updatingOrders[order.orderId] ? (
                                    <div className="animate-spin rounded-full h-2.5 w-2.5 border-b-1 border-white"></div>
                                  ) : (
                                    <FiCheck size={10} />
                                  )}
                                </button>
                                <button
                                  ...
                                  disabled={updatingOrders[order.orderId]}
                                  className="flex-1 bg-red-500 hover:bg-red-600 text-white text-xs py-0.5 px-1.5 rounded flex items-center justify-center transition-colors disabled:opacity-50"
                                  title="Reject Order"
                                >
                                  {updatingOrders[order.orderId] ? (
                                    <div className="animate-spin rounded-full h-2.5 w-2.5 border-b-1 border-white"></div>
                              ...
                              <span className={`text-xs px-1.5 py-0.5 rounded-full text-center ${getStatusColor(order.orderStatus)}`}>
                            ...
                            <div className="relative">
                              {updatingOrders[order.orderId] ? (
                                ...
                                <select
                                  ...
                                  className={`text-xs px-1.5 py-0.5 rounded-full border ${getStatusColor(order.orderStatus)} cursor-pointer w-full`}
                                  disabled={updatingOrders[order.orderId]}
