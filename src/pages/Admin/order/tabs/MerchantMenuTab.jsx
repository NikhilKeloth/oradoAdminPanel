              ...
              {form.items.map((it, idx) => (
                ...
                >
                  <div className="col-span-5">
                    ...
                    />
                    {it.isCustom && (
                      <span className="text-xs text-blue-600 mt-1">Custom Item</span>
                    )}
                  </div>
                  ...
                  <div className="col-span-2">
                    ...
                    <div className="flex items-center space-x-2">
                      {/* For menu products, show quantity controls that use the same API */}
                      {!it.isCustom ? (
                        <div className="flex items-center space-x-2 bg-orange-500 text-white rounded-full px-3 py-1">
                          <button
                            type="button"
                            onClick={() => decreaseProductQuantity({ _id: it.productId, name: it.name, price: it.price })}
                            className="p-1 hover:bg-orange-600 rounded-full transition-all"
                          >
                            <FiMinus className="text-xs" />
                          </button>
                          ...
                          <button
                            type="button"
                            onClick={() => addProductFromMerchant({ _id: it.productId, name: it.name, price: it.price })}
                            className="p-1 hover:bg-orange-600 rounded-full transition-all"
                          >
                            <FiPlus className="text-xs" />
                          </button>
                        ...
                        // For custom items, keep the number input
                        <input
                          type="number"
                          min={1}
                          value={it.qty}
